...
to_field 'geographic_srpt' do |resource, accumulator, _context|
  coordinates = resource.cocina_record.coordinates_as_envelope.any? ? resource.cocina_record.coordinates_as_envelope : resource.cocina_record.coordinates_as_point
  coordinates.each { |v| accumulator << v }
end
