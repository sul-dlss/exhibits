...
ActiveRecord::Schema.define(version: 20_151_016_191_759) do
  ...
  add_index 'bookmarks', %w(document_type document_id), name: 'index_bookmarks_on_document_type_and_document_id'
  ...
  add_index 'spotlight_contact_emails', %w(email exhibit_id), name: 'index_spotlight_contact_emails_on_email_and_exhibit_id', unique: true
  ...
  add_index 'spotlight_locks', %w(on_id on_type), name: 'index_spotlight_locks_on_on_id_and_on_type', unique: true
  ...
  add_index 'spotlight_pages', %w(slug scope), name: 'index_spotlight_pages_on_slug_and_scope', unique: true
  ...
  add_index 'spotlight_roles', %w(exhibit_id user_id), name: 'index_spotlight_roles_on_exhibit_id_and_user_id', unique: true
  ...
  add_index 'spotlight_searches', %w(slug scope), name: 'index_spotlight_searches_on_slug_and_scope', unique: true
