...
set :linked_files, %w{config/database.yml config/solr.yml config/harvestdor.yml config/initializers/secret_token.rb config/initializers/squash.rb public/.htaccess}
