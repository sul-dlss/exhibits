...
# SCT: Switch this to > v1.3.0 once we're done with the heatmaps work.
gem 'blacklight_heatmaps', github: 'sul-dlss/blacklight_heatmaps', branch: 'master'
# SCT: Switch this to v5 once it's released
